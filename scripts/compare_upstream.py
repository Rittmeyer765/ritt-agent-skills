...
def main() -> None:
    ...
    candidate_dir = ROOT / "upstream" / "mattpocock" / "snapshots" / args.candidate
    accepted_dir = ROOT / "upstream" / "mattpocock" / "snapshots" / accepted_revision
    ...
    report_path = ROOT / "reports" / "upstream" / f"compare-{args.candidate}.md"
